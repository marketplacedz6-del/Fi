...
function App() {
  ...
  const addToCart = (id: number, quantity = 1) => {
    ...
    trackCommerceEvent('AddToCart', { content_ids: [id], content_name: product.name[lang], value: product.price * acceptedQuantity, currency: 'DZD', quantity: acceptedQuantity })
